<template>
    <button @click="$colorMode.preference = $colorMode.preference === 'dark' ? 'light' : 'dark'" class="text-primary-500">
        <svg v-if="$colorMode.preference === 'dark'" xmlns="http://www.w3.org/2000/svg"
        ...
        <svg v-if="$colorMode.preference === 'light'" style="width:24px;height:24px" viewBox="0 0 24 24" >
