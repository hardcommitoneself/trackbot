<template>
    <button @click="$colorMode.value = $colorMode.value === 'dark' ? 'light' : 'dark'" class="text-primary-500">
        ...
        <svg v-if="$colorMode.value === 'light'" style="width:24px;height:24px" viewBox="0 0 24 24" >
